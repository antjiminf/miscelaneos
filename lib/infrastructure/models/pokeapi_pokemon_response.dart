...
//
//     final pokemonApiResponse = pokemonApiResponseFromJson(jsonString);

import 'dart:convert';

PokemonApiResponse pokemonApiResponseFromJson(String str) =>
    PokemonApiResponse.fromJson(json.decode(str));

String pokemonApiResponseToJson(PokemonApiResponse data) =>
